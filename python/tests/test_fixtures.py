...
def test_attr1_fixture_matches_spec_table() -> None:
    ...
    assert view.opponent_state_present.tolist() == [0, 0, 0, 0]
    assert view.opponent_node_count.tolist() == [0, 0, 0, 0]
...
def test_attr0_fixture_omits_attrs() -> None:
    ...
    assert view.opponent_state_present.tolist() == [0, 0]
    assert view.opponent_node_count.tolist() == [0, 0]

...
fn parse_selfplay(args: Vec<String>) -> Result<SelfplayConfig, String> {
    ...
    while index < args.len() {
        ...
        match flag.as_str() {
            ...
            "--training-mode" => config.training_mode = value.parse()?,

...
pub use backend::{BackendOutputs, FeatureEvalBackend, ModelGeneration, PendingBatch, StubBackend};
pub use error::{ServiceError, ServiceResult};
pub use frames::{
    FRAME_ERROR, FRAME_EVAL, FRAME_EVAL_RESULT, FRAME_HELLO, FRAME_HELLO_ACK, FRAME_MODEL_RELEASE,
    FRAME_PING, FRAME_PONG, MAX_FRAME, PROTOCOL_VERSION, read_frame, write_frame,
};
pub use hello::{
